      ...
      >
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="flex gap-x-[3.3px] items-center mt-[21px]">
            <Input
              className="flex-1 w-[40%]  h-[50px] code-input font-404px text-[16px] leading-[16px]"
            ...
            />
            <Button className="memoo_button h-[50px] w-[60%] " onClick={onConfirm} loading={confirming}>
