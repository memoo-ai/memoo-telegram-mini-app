...
declare interface PinnedTwitterUrls {
  id: number;
  pinnedTwitterUrl: string;
}
...
declare interface DashboardCreator {
  ...
  ready: boolean;
  readyFlag: boolean;
  stageOneClaimedFlag: string;
  stageTwoClaimedFlag: string;
  teamFlag: string;
}
...
declare interface TrendingTokens {
  ...
  creatorTotalRaisedDenominator: number;
  creatorTotalRaisedNumerator: number;
}
...
declare interface ProfileDetail {
  ...
  collectiveMarketCap: string;
  collectiveAthMarketCap: string;
  totalHolders: string;
  totalHoldersGrowth: string;
  rankTotalTokensCreated: number;
  rankTotalTokensWithMemooScore: number;
  rankAthMarketCap: number;
  rankMeMooScoreAth: number;
  rankAthHolders: number;
  rankCumulativeMcap: number;
  rankCumulativeAthMcap: number;
  rankCumulativeHolders: number;
  rankHolderGrow7Days: number;
  rankMarketCapGrowth7Days: number;
  totalTokensCreateds: number;
  totalTokensMemooScores: number;
}
...
declare interface TeamQuota {
  teamAddress: string;
  quota: number;
}
declare interface TradeHistorys {
  address: string;
  proportion: string;
  userType: string;
}
declare interface ReferralType {
  Score: number;
  invitationScore: number;
  Invitations: number;
  Rank: number;
}
declare interface DashboardRefund {
  banners: string[];
  createdAt: number;
  icon: string;
  launchDate: number;
...
declare interface TelegramBind {
  first_name: string;
  id: number;
  last_name: string;
  photo_url: string;
